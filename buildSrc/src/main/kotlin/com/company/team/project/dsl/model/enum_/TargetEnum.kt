...
enum class TargetEnum(
	...
	`common-multiple_sources@linux_arm32_hfp`( defaultStatus = enabled ),
	`common-multiple_sources@linux_mips32`( defaultStatus = enabled ),
	`common-multiple_sources@linux_mipsel32`( defaultStatus = enabled ),
	`common-multiple_sources@linux_x64`( defaultStatus = enabled ),
	`common-multiple_sources@macos_x64`( defaultStatus = enabled ),
	`common-multiple_sources@mingw_x64`( defaultStatus = enabled ),
	`common-multiple_sources@mingw_x86`( defaultStatus = enabled ),
	`common-multiple_sources@tvos_arm64`( defaultStatus = enabled ),
	`common-multiple_sources@tvos_x64`( defaultStatus = enabled ),
	`common-multiple_sources@wasm32`( defaultStatus = enabled ),
	`common-multiple_sources@watchos_arm32`( defaultStatus = enabled ),
	`common-multiple_sources@watchos_arm64`( defaultStatus = enabled ),
	`common-multiple_sources@watchos_x64`( defaultStatus = enabled ),
	`common-multiple_sources@watchos_x86`( defaultStatus = enabled ),
	...
	`common-single_source@linux_arm32_hfp`( defaultStatus = enabled ),
	`common-single_source@linux_mips32`( defaultStatus = enabled ),
	`common-single_source@linux_mipsel32`( defaultStatus = enabled ),
	`common-single_source@linux_x64`( defaultStatus = enabled ),
	`common-single_source@macos_x64`( defaultStatus = enabled ),
	`common-single_source@mingw_x64`( defaultStatus = enabled ),
	`common-single_source@mingw_x86`( defaultStatus = enabled ),
	`common-single_source@tvos_arm64`( defaultStatus = enabled ),
	`common-single_source@tvos_x64`( defaultStatus = enabled ),
	`common-single_source@wasm32`( defaultStatus = enabled ),
	`common-single_source@watchos_arm32`( defaultStatus = enabled ),
	`common-single_source@watchos_arm64`( defaultStatus = enabled ),
	`common-single_source@watchos_x64`( defaultStatus = enabled ),
	`common-single_source@watchos_x86`( defaultStatus = enabled ),
	...
	`library-multiple_sources@linux_arm32_hfp`( defaultStatus = enabled ),
	`library-multiple_sources@linux_mips32`( defaultStatus = enabled ),
	`library-multiple_sources@linux_mipsel32`( defaultStatus = enabled ),
	`library-multiple_sources@linux_x64`( defaultStatus = enabled ),
	`library-multiple_sources@macos_x64`( defaultStatus = enabled ),
	`library-multiple_sources@mingw_x64`( defaultStatus = enabled ),
	`library-multiple_sources@mingw_x86`( defaultStatus = enabled ),
	`library-multiple_sources@tvos_arm64`( defaultStatus = enabled ),
	`library-multiple_sources@tvos_x64`( defaultStatus = enabled ),
	`library-multiple_sources@wasm32`( defaultStatus = enabled ),
	`library-multiple_sources@watchos_arm32`( defaultStatus = enabled ),
	`library-multiple_sources@watchos_arm64`( defaultStatus = enabled ),
	`library-multiple_sources@watchos_x64`( defaultStatus = enabled ),
	`library-multiple_sources@watchos_x86`( defaultStatus = enabled ),

	`library-single_source@android_native_arm32`( defaultStatus = enabled ),
	`library-single_source@android_native_arm64`( defaultStatus = enabled ),
	...
	`library-single_source@linux_arm32_hfp`( defaultStatus = enabled ),
	`library-single_source@linux_mips32`( defaultStatus = enabled ),
	`library-single_source@linux_mipsel32`( defaultStatus = enabled ),
	`library-single_source@linux_x64`( defaultStatus = enabled ),
	`library-single_source@macos_x64`( defaultStatus = enabled ),
	`library-single_source@mingw_x64`( defaultStatus = enabled ),
	`library-single_source@mingw_x86`( defaultStatus = enabled ),
	`library-single_source@tvos_arm64`( defaultStatus = enabled ),
	`library-single_source@tvos_x64`( defaultStatus = enabled ),
	`library-single_source@wasm32`( defaultStatus = enabled ),
	`library-single_source@watchos_arm32`( defaultStatus = enabled ),
	`library-single_source@watchos_arm64`( defaultStatus = enabled ),
	`library-single_source@watchos_x64`( defaultStatus = enabled ),
	`library-single_source@watchos_x86`( defaultStatus = enabled ),
