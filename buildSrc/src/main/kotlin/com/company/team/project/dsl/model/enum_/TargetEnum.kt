...
enum class TargetEnum(
	...
	`common-single_source@android_native_arm32`( defaultStatus = disabled ),
	`common-single_source@android_native_arm64`( defaultStatus = disabled ),
	`common-single_source@ios_arm32`( defaultStatus = disabled ),
	`common-single_source@ios_arm64`( defaultStatus = disabled ),
	...
	`library-multiple_sources@android_native_arm32`( defaultStatus = disabled ),
	`library-multiple_sources@android_native_arm64`( defaultStatus = disabled ),
	`library-multiple_sources@ios_arm32`( defaultStatus = disabled ),
	`library-multiple_sources@ios_arm64`( defaultStatus = disabled ),
	...
	`library-single_source@android_native_arm32`( defaultStatus = disabled ),
	`library-single_source@android_native_arm64`( defaultStatus = disabled ),
	`library-single_source@ios_arm32`( defaultStatus = disabled ),
	`library-single_source@ios_arm64`( defaultStatus = disabled ),
