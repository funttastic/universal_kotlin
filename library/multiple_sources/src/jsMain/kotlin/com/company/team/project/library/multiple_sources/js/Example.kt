...
fun checkExampleObjectPackageAndReturnIt(): String {
	val expectedPackage = "com.company.team.project.library.multiple_sources.js"
	if (
		ExampleObject::class.js.name
		=== `_`.com.company.team.project.library.multiple_sources.js.ExampleObject::class.js.name
	) {
